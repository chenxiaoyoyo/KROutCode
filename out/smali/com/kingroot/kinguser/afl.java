package com.kingroot.kinguser; class afl { void a() { int a;
a=0;// .class public Lcom/kingroot/kinguser/afl;
a=0;// .super Ljava/lang/Object;
a=0;// # done
a=0;// 
a=0;// # direct methods
a=0;// .method public static u(Landroid/content/Context;Ljava/lang/String;)Landroid/content/res/Resources;
a=0;//     .locals 6
a=0;// 
a=0;//     :try_start_0
...
a=0;//     move-result-object v2
a=0;// 
a=0;//     invoke-direct {v1, v0, v3, v2}, Landroid/content/res/Resources;-><init>(Landroid/content/res/AssetManager;Landroid/util/DisplayMetrics;Landroid/content/res/Configuration;)V
a=0;//     :try_end_0
