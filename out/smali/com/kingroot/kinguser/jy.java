package com.kingroot.kinguser; class jy { void a() { int a;
a=0;// .class public Lcom/kingroot/kinguser/jy;
a=0;// .super Ljava/lang/Object;
a=0;// .source "SourceFile"
a=0;// 
a=0;// 
a=0;// # instance fields
a=0;// .field private kA:I
a=0;// 
a=0;// 
a=0;// # direct methods
...
a=0;// 
a=0;//     .line 7
a=0;//     #p0=(Reference,Lcom/kingroot/kinguser/jy;);
a=0;//     const/4 v0, -0x1
a=0;// 
a=0;//     #v0=(Byte);
a=0;//     iput v0, p0, Lcom/kingroot/kinguser/jy;->kA:I
a=0;// 
a=0;//     .line 10
a=0;//     invoke-virtual {p0}, Lcom/kingroot/kinguser/jy;->gX()I
a=0;// 
a=0;//     move-result v0
a=0;// 
a=0;//     #v0=(Integer);
...
a=0;// 
a=0;//     .line 14
a=0;//     iput p1, p0, Lcom/kingroot/kinguser/jy;->kA:I
a=0;// 
a=0;//     .line 15
a=0;//     return-void
a=0;// .end method
...
a=0;// .end method
a=0;// 
a=0;// .method public final c(Landroid/os/Bundle;)Z
a=0;//     .locals 3
a=0;// 
a=0;//     .prologue
a=0;//     const/4 v2, -0x1
...
a=0;// 
a=0;//     #v1=(Integer);
a=0;//     iput v1, p0, Lcom/kingroot/kinguser/jy;->kA:I
a=0;// 
a=0;//     .line 43
a=0;//     iget v1, p0, Lcom/kingroot/kinguser/jy;->kA:I
a=0;// 
...
a=0;//     invoke-virtual {p0, v0}, Lcom/kingroot/kinguser/jy;->b(Landroid/os/Bundle;)Z
a=0;// 
a=0;//     move-result v0
a=0;// 
a=0;//     #v0=(Boolean);
...
a=0;//     .prologue
a=0;//     .line 57
a=0;//     iget v0, p0, Lcom/kingroot/kinguser/jy;->kA:I
a=0;// 
a=0;//     #v0=(Integer);
a=0;//     return v0
a=0;// .end method
...
a=0;// .end method
a=0;// 
a=0;// .method public final getBundle()Landroid/os/Bundle;
a=0;//     .locals 3
a=0;// 
a=0;//     .prologue
a=0;//     .line 18
...
a=0;// 
a=0;//     #v1=(Reference,Ljava/lang/String;);
a=0;//     iget v2, p0, Lcom/kingroot/kinguser/jy;->kA:I
a=0;// 
a=0;//     #v2=(Integer);
a=0;//     invoke-virtual {v0, v1, v2}, Landroid/os/Bundle;->putInt(Ljava/lang/String;I)V
a=0;// 
a=0;//     .line 23
a=0;//     invoke-virtual {p0}, Lcom/kingroot/kinguser/jy;->gY()Landroid/os/Bundle;
a=0;// 
