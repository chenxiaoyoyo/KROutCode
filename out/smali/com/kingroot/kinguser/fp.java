package com.kingroot.kinguser; class fp { void a() { int a;
a=0;// .class Lcom/kingroot/kinguser/fp;
...
a=0;//     .prologue
a=0;//     .line 561
a=0;//     iput-object p1, p0, Lcom/kingroot/kinguser/fp;->ge:Lcom/kingroot/kinguser/fn;
a=0;// 
a=0;//     invoke-direct {p0}, Lcom/kingroot/kinguser/vz;-><init>()V
a=0;// 
a=0;//     #p0=(Reference,Lcom/kingroot/kinguser/fp;);
a=0;//     return-void
a=0;// .end method
a=0;// 
a=0;// 
...
a=0;//     const-string v2, "/data/local/tmp"
a=0;// 
