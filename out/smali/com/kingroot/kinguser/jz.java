package com.kingroot.kinguser; class jz { void a() { int a;
a=0;// .class public final Lcom/kingroot/kinguser/jz;
a=0;// .super Lcom/kingroot/kinguser/jy;
a=0;// .source "SourceFile"
a=0;// 
a=0;// 
a=0;// # instance fields
a=0;// .field private kB:Z
a=0;// 
a=0;// 
a=0;// # direct methods
...
a=0;// 
a=0;//     .line 9
a=0;//     #p0=(Reference,Lcom/kingroot/kinguser/jz;);
a=0;//     const/4 v0, 0x0
a=0;// 
a=0;//     #v0=(Null);
a=0;//     iput-boolean v0, p0, Lcom/kingroot/kinguser/jz;->kB:Z
a=0;// 
a=0;//     return-void
a=0;// .end method
a=0;// 
...
a=0;//     iget-boolean v2, p0, Lcom/kingroot/kinguser/jz;->kB:Z
a=0;// 
a=0;//     #v2=(Boolean);
...
a=0;// .end method
a=0;// 
a=0;// .method public gZ()Z
a=0;//     .locals 1
a=0;// 
a=0;//     .prologue
a=0;//     .line 33
a=0;//     iget-boolean v0, p0, Lcom/kingroot/kinguser/jz;->kB:Z
a=0;// 
a=0;//     #v0=(Boolean);
a=0;//     return v0
a=0;// .end method
