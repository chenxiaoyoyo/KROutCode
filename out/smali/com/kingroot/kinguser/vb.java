package com.kingroot.kinguser; class vb { void a() { int a;
a=0;// .class public Lcom/kingroot/kinguser/vb;
a=0;// .super Landroid/content/pm/PackageManager;
a=0;// .source "SourceFile"
a=0;// 
a=0;// 
a=0;// # static fields
a=0;// .field private static volatile uf:Lcom/kingroot/kinguser/vb;
a=0;// 
a=0;// 
a=0;// # direct methods
...
a=0;// 
a=0;//     #v0=(Null);
a=0;//     sput-object v0, Lcom/kingroot/kinguser/vb;->uf:Lcom/kingroot/kinguser/vb;
a=0;// 
a=0;//     return-void
a=0;// .end method
a=0;// 
...
a=0;// 
a=0;//     .line 62
a=0;//     #p0=(Reference,Lcom/kingroot/kinguser/vb;);
a=0;//     return-void
a=0;// .end method
a=0;// 
a=0;// .method private getPackageManager()Landroid/content/pm/PackageManager;
a=0;//     .locals 1
a=0;// 
a=0;//     .prologue
a=0;//     .line 76
...
a=0;// .end method
a=0;// 
a=0;// .method public static kZ()Lcom/kingroot/kinguser/vb;
a=0;//     .locals 2
a=0;// 
a=0;//     .prologue
a=0;//     .line 65
a=0;//     sget-object v0, Lcom/kingroot/kinguser/vb;->uf:Lcom/kingroot/kinguser/vb;
a=0;// 
a=0;//     #v0=(Reference,Lcom/kingroot/kinguser/vb;);
a=0;//     if-nez v0, :cond_1
a=0;// 
a=0;//     .line 66
a=0;//     const-class v1, Lcom/kingroot/kinguser/vb;
a=0;// 
...
a=0;// 
a=0;//     .line 68
a=0;//     new-instance v0, Lcom/kingroot/kinguser/vb;
a=0;// 
a=0;//     #v0=(UninitRef,Lcom/kingroot/kinguser/vb;);
a=0;//     invoke-direct {v0}, Lcom/kingroot/kinguser/vb;-><init>()V
a=0;// 
a=0;//     #v0=(Reference,Lcom/kingroot/kinguser/vb;);
a=0;//     sput-object v0, Lcom/kingroot/kinguser/vb;->uf:Lcom/kingroot/kinguser/vb;
a=0;// 
...
a=0;//     .line 752
a=0;//     :try_start_0
a=0;//     invoke-direct {p0}, Lcom/kingroot/kinguser/vb;->getPackageManager()Landroid/content/pm/PackageManager;
a=0;// 
a=0;//     move-result-object v0
a=0;// 
...
a=0;// .end method
a=0;// 
a=0;// .method public setInstallerPackageName(Ljava/lang/String;Ljava/lang/String;)V
a=0;//     .locals 1
a=0;// 
a=0;//     .prologue
a=0;//     .line 954
...
a=0;// 
a=0;//     #v0=(Reference,Landroid/content/pm/PackageManager;);
a=0;//     invoke-virtual {v0, p1, p2}, Landroid/content/pm/PackageManager;->setInstallerPackageName(Ljava/lang/String;Ljava/lang/String;)V
a=0;//     :try_end_0
a=0;//     .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_0
a=0;// 
a=0;//     .line 958
...
a=0;// .end method
a=0;// 
a=0;// .method public verifyPendingInstall(II)V
a=0;//     .locals 1
a=0;// 
a=0;//     .prologue
a=0;//     .line 963
...
a=0;// 
a=0;//     #v0=(Reference,Landroid/content/pm/PackageManager;);
a=0;//     invoke-virtual {v0, p1, p2}, Landroid/content/pm/PackageManager;->verifyPendingInstall(II)V
a=0;//     :try_end_0
a=0;//     .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_0
a=0;// 
a=0;//     .line 967
