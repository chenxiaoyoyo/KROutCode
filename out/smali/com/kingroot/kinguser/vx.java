package com.kingroot.kinguser; class vx { void a() { int a;
a=0;// .class public final Lcom/kingroot/kinguser/vx;
...
a=0;// 
a=0;//     sput-object v0, Lcom/kingroot/kinguser/vx;->kn:Ljava/lang/Class;
a=0;// 
a=0;//     .line 28
a=0;//     sget-object v0, Lcom/kingroot/kinguser/vx;->kn:Ljava/lang/Class;
a=0;// 
...
a=0;//     move-result-object v0
a=0;// 
a=0;//     sput-object v0, Lcom/kingroot/kinguser/vx;->ko:Ljava/lang/reflect/Method;
a=0;// 
a=0;//     .line 29
a=0;//     sget-object v0, Lcom/kingroot/kinguser/vx;->kn:Ljava/lang/Class;
a=0;// 
...
a=0;//     move-result-object v0
a=0;// 
a=0;//     sput-object v0, Lcom/kingroot/kinguser/vx;->kp:Ljava/lang/reflect/Method;
a=0;// 
a=0;//     .line 30
a=0;//     sget-object v0, Lcom/kingroot/kinguser/vx;->kn:Ljava/lang/Class;
a=0;// 
...
a=0;//     move-result-object v0
a=0;// 
a=0;//     sput-object v0, Lcom/kingroot/kinguser/vx;->kq:Ljava/lang/reflect/Method;
a=0;// 
a=0;//     .line 31
a=0;//     sget-object v0, Lcom/kingroot/kinguser/vx;->kn:Ljava/lang/Class;
a=0;// 
...
a=0;//     move-result-object v0
a=0;// 
a=0;//     sput-object v0, Lcom/kingroot/kinguser/vx;->kr:Ljava/lang/reflect/Method;
a=0;// 
a=0;//     .line 34
a=0;//     sget-object v0, Lcom/kingroot/kinguser/vx;->kn:Ljava/lang/Class;
a=0;// 
...
a=0;// 
a=0;//     sput-object v0, Lcom/kingroot/kinguser/vx;->sCache:Ljava/util/HashMap;
a=0;//     :try_end_0
...
a=0;// .end method
a=0;// 
a=0;// .method public static cg(Ljava/lang/String;)Landroid/os/IBinder;
a=0;//     .locals 3
a=0;// 
a=0;//     .prologue
a=0;//     .line 74
a=0;//     sget-object v0, Lcom/kingroot/kinguser/vx;->ko:Ljava/lang/reflect/Method;
a=0;// 
...
a=0;// 
a=0;//     invoke-static {v0, v1}, Lcom/kingroot/kinguser/vx;->a(Ljava/lang/reflect/Method;[Ljava/lang/Object;)Ljava/lang/Object;
a=0;// 
a=0;//     move-result-object v0
a=0;// 
