package com.kingroot.kinguser; class aac { void a() { int a;
a=0;// .class public final Lcom/kingroot/kinguser/aac;
...
a=0;// 
a=0;//     .line 13
a=0;//     #p0=(Reference,Lcom/kingroot/kinguser/aac;);
a=0;//     const-string v0, ""
a=0;// 
a=0;//     #v0=(Reference,Ljava/lang/String;);
a=0;//     iput-object v0, p0, Lcom/kingroot/kinguser/aac;->yG:Ljava/lang/String;
a=0;// 
a=0;//     .line 16
a=0;//     return-void
a=0;// .end method
...
a=0;//     .prologue
a=0;//     .line 26
a=0;//     iget-object v0, p0, Lcom/kingroot/kinguser/aac;->yG:Ljava/lang/String;
a=0;// 
a=0;//     #v0=(Reference,Ljava/lang/String;);
a=0;//     const/4 v1, 0x0
a=0;// 
...
a=0;//     iget-object v1, p0, Lcom/kingroot/kinguser/aac;->yG:Ljava/lang/String;
a=0;// 
