package com.kingroot.kinguser.storage; class SpProvider { void a() { int a;
a=0;// .class public Lcom/kingroot/kinguser/storage/SpProvider;
...
a=0;// 
a=0;// # direct methods
a=0;// .method private a(Landroid/net/Uri;)Ljava/lang/String;
a=0;//     .locals 2
a=0;// 
a=0;//     .prologue
a=0;//     .line 219
...
a=0;// .end method
a=0;// 
a=0;// .method private g(Ljava/lang/Object;)Ljava/lang/String;
a=0;//     .locals 2
a=0;// 
a=0;//     .prologue
a=0;//     .line 129
...
a=0;//     .line 55
a=0;//     #v0=(Null);
a=0;//     invoke-direct {p0, p1}, Lcom/kingroot/kinguser/storage/SpProvider;->a(Landroid/net/Uri;)Ljava/lang/String;
a=0;// 
a=0;//     move-result-object v1
a=0;// 
a=0;//     .line 56
...
a=0;//     iget-object v2, p0, Lcom/kingroot/kinguser/storage/SpProvider;->mContext:Landroid/content/Context;
a=0;// 
...
a=0;//     iget-object v1, p0, Lcom/kingroot/kinguser/storage/SpProvider;->mContext:Landroid/content/Context;
a=0;// 
...
a=0;// 
a=0;//     #v1=(Integer);
a=0;//     invoke-direct {v2, v0, v1}, Landroid/database/MatrixCursor;-><init>([Ljava/lang/String;I)V
a=0;// 
a=0;//     .line 165
...
a=0;//     invoke-direct {p0, v1}, Lcom/kingroot/kinguser/storage/SpProvider;->g(Ljava/lang/Object;)Ljava/lang/String;
a=0;// 
...
a=0;// 
a=0;//     invoke-virtual {v2, v6}, Landroid/database/MatrixCursor;->addRow([Ljava/lang/Object;)V
a=0;// 
a=0;//     goto :goto_1
a=0;// 
a=0;//     :cond_3
...
a=0;//     .line 177
a=0;//     :cond_4
a=0;//     #v0=(Reference,Ljava/lang/String;);v6=(Boolean);v7=(Conflicted);
a=0;//     const/4 v6, 0x3
a=0;// 
a=0;//     #v6=(PosByte);
a=0;//     new-array v6, v6, [Ljava/lang/Object;
...
a=0;//     .line 184
a=0;//     :cond_5
a=0;//     #v0=(Null);v3=(Uninit);v4=(Uninit);v5=(Uninit);v6=(Uninit);v7=(Uninit);
...
a=0;//     .line 192
a=0;//     :cond_8
a=0;//     #v1=(Reference,Landroid/database/MatrixCursor;);v3=(Boolean);v4=(Reference,Ljava/lang/String;);v5=(Uninit);v6=(Uninit);v7=(Uninit);
