package com.kingroot.kinguser; class kd { void a() { int a;
a=0;// .class public Lcom/kingroot/kinguser/kd;
...
a=0;// 
a=0;//     .line 9
a=0;//     #p0=(Reference,Lcom/kingroot/kinguser/kd;);
a=0;//     const/4 v0, 0x0
a=0;// 
a=0;//     #v0=(Null);
a=0;//     iput v0, p0, Lcom/kingroot/kinguser/kd;->kH:I
a=0;// 
a=0;//     return-void
a=0;// .end method
a=0;// 
...
a=0;// 
a=0;//     #v1=(Reference,Ljava/lang/String;);
a=0;//     iget v2, p0, Lcom/kingroot/kinguser/kd;->kH:I
a=0;// 
a=0;//     #v2=(Integer);
