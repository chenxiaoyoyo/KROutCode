...
a=0;// 
a=0;//     .line 249
a=0;//     new-instance v0, Landroid/support/v4/view/MenuItemCompat$IcsMenuVersionImpl;
a=0;// 
a=0;//     #v0=(UninitRef,Landroid/support/v4/view/MenuItemCompat$IcsMenuVersionImpl;);
a=0;//     invoke-direct {v0}, Landroid/support/v4/view/MenuItemCompat$IcsMenuVersionImpl;-><init>()V
a=0;// 
a=0;//     #v0=(Reference,Landroid/support/v4/view/MenuItemCompat$IcsMenuVersionImpl;);
