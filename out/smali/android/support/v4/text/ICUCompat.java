...
a=0;// 
a=0;//     .line 57
a=0;//     new-instance v0, Landroid/support/v4/text/ICUCompat$ICUCompatImplIcs;
a=0;// 
a=0;//     #v0=(UninitRef,Landroid/support/v4/text/ICUCompat$ICUCompatImplIcs;);
a=0;//     invoke-direct {v0}, Landroid/support/v4/text/ICUCompat$ICUCompatImplIcs;-><init>()V
a=0;// 
a=0;//     #v0=(Reference,Landroid/support/v4/text/ICUCompat$ICUCompatImplIcs;);
a=0;//     sput-object v0, Landroid/support/v4/text/ICUCompat;->IMPL:Landroid/support/v4/text/ICUCompat$ICUCompatImpl;
a=0;// 
a=0;//     .line 61
a=0;//     :goto_0
a=0;//     return-void
...
a=0;//     :cond_0
a=0;//     #v0=(Integer);
a=0;//     new-instance v0, Landroid/support/v4/text/ICUCompat$ICUCompatImplBase;
a=0;// 
a=0;//     #v0=(UninitRef,Landroid/support/v4/text/ICUCompat$ICUCompatImplBase;);
a=0;//     invoke-direct {v0}, Landroid/support/v4/text/ICUCompat$ICUCompatImplBase;-><init>()V
a=0;// 
a=0;//     #v0=(Reference,Landroid/support/v4/text/ICUCompat$ICUCompatImplBase;);
a=0;//     sput-object v0, Landroid/support/v4/text/ICUCompat;->IMPL:Landroid/support/v4/text/ICUCompat$ICUCompatImpl;
a=0;// 
a=0;//     goto :goto_0
a=0;// .end method
