...
a=0;// 
a=0;//     #v0=(Reference,[B);
a=0;//     sput-object v0, Landroid/support/v4/text/BidiFormatter$DirectionalityEstimator;->DIR_TYPE_CACHE:[B
a=0;// 
a=0;//     .line 506
a=0;//     const/4 v0, 0x0
a=0;// 
...
a=0;//     .line 877
a=0;//     :goto_0
a=0;//     #v0=(PosByte);v1=(Integer);v2=(Conflicted);
a=0;//     return v0
a=0;// 
a=0;//     .line 871
a=0;//     :cond_1
a=0;//     #v0=(Integer);v1=(Char);v2=(PosByte);
a=0;//     iget-char v1, p0, Landroid/support/v4/text/BidiFormatter$DirectionalityEstimator;->lastChar:C
a=0;// 
...
a=0;// 
a=0;//     #v1=(Integer);
a=0;//     iget v2, p0, Landroid/support/v4/text/BidiFormatter$DirectionalityEstimator;->length:I
a=0;// 
a=0;//     #v2=(Integer);
...
a=0;//     .line 809
a=0;//     :goto_0
a=0;//     #v0=(PosByte);v1=(Integer);v2=(Integer);v3=(Conflicted);
a=0;//     return v0
a=0;// 
a=0;//     .line 800
a=0;//     :cond_1
a=0;//     #v0=(Integer);v1=(Char);v2=(PosByte);v3=(Integer);
a=0;//     iget-char v1, p0, Landroid/support/v4/text/BidiFormatter$DirectionalityEstimator;->lastChar:C
a=0;// 
a=0;//     const/16 v2, 0x22
a=0;// 
...
a=0;// 
a=0;//     .line 768
a=0;//     iget-char v0, p0, Landroid/support/v4/text/BidiFormatter$DirectionalityEstimator;->lastChar:C
a=0;// 
a=0;//     invoke-static {v0}, Ljava/lang/Character;->isLowSurrogate(C)Z
a=0;// 
a=0;//     move-result v0
a=0;// 
a=0;//     #v0=(Boolean);
...
a=0;//     iget v1, p0, Landroid/support/v4/text/BidiFormatter$DirectionalityEstimator;->charIndex:I
a=0;// 
a=0;//     invoke-static {v0, v1}, Ljava/lang/Character;->codePointBefore(Ljava/lang/CharSequence;I)I
a=0;// 
a=0;//     move-result v0
a=0;// 
a=0;//     .line 770
...
a=0;// 
a=0;//     iput v1, p0, Landroid/support/v4/text/BidiFormatter$DirectionalityEstimator;->charIndex:I
a=0;// 
a=0;//     .line 771
a=0;//     invoke-static {v0}, Ljava/lang/Character;->getDirectionality(I)B
a=0;// 
...
a=0;// 
a=0;//     #v0=(Char);
a=0;//     invoke-static {v0}, Landroid/support/v4/text/BidiFormatter$DirectionalityEstimator;->getCachedDirectionality(C)B
a=0;// 
a=0;//     move-result v0
a=0;// 
a=0;//     .line 775
a=0;//     #v0=(Byte);
a=0;//     iget-boolean v1, p0, Landroid/support/v4/text/BidiFormatter$DirectionalityEstimator;->isHtml:Z
a=0;// 
a=0;//     #v1=(Boolean);
...
a=0;//     iget-char v0, p0, Landroid/support/v4/text/BidiFormatter$DirectionalityEstimator;->lastChar:C
a=0;// 
a=0;//     invoke-static {v0}, Ljava/lang/Character;->isHighSurrogate(C)Z
a=0;// 
a=0;//     move-result v0
a=0;// 
a=0;//     #v0=(Boolean);
...
a=0;//     iget v1, p0, Landroid/support/v4/text/BidiFormatter$DirectionalityEstimator;->charIndex:I
a=0;// 
a=0;//     invoke-static {v0, v1}, Ljava/lang/Character;->codePointAt(Ljava/lang/CharSequence;I)I
a=0;// 
a=0;//     move-result v0
a=0;// 
a=0;//     .line 740
...
a=0;//     :goto_0
a=0;//     :pswitch_0
a=0;//     #v0=(Integer);v2=(Integer);v3=(Byte);v6=(Conflicted);v7=(Conflicted);
...
a=0;//     .line 665
a=0;//     #v1=(Null);
a=0;//     iget v0, p0, Landroid/support/v4/text/BidiFormatter$DirectionalityEstimator;->length:I
a=0;// 
a=0;//     #v0=(Integer);
a=0;//     iput v0, p0, Landroid/support/v4/text/BidiFormatter$DirectionalityEstimator;->charIndex:I
a=0;// 
...
a=0;//     iget v5, p0, Landroid/support/v4/text/BidiFormatter$DirectionalityEstimator;->charIndex:I
a=0;// 
a=0;//     #v5=(Integer);
