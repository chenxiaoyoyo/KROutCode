...
a=0;//     .prologue
a=0;//     .line 54
a=0;//     sget-object v1, Landroid/support/v4/hardware/display/DisplayManagerCompat;->sInstances:Ljava/util/WeakHashMap;
a=0;// 
...
a=0;//     .line 55
a=0;//     :try_start_0
a=0;//     sget-object v0, Landroid/support/v4/hardware/display/DisplayManagerCompat;->sInstances:Ljava/util/WeakHashMap;
a=0;// 
a=0;//     #v0=(Reference,Ljava/util/WeakHashMap;);
