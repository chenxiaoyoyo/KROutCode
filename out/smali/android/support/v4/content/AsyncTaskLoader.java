...
a=0;// 
a=0;//     #v1=(Null);
a=0;//     iput-boolean v1, v0, Landroid/support/v4/content/AsyncTaskLoader$LoadTask;->waiting:Z
a=0;// 
a=0;//     .line 180
a=0;//     iget-object v0, p0, Landroid/support/v4/content/AsyncTaskLoader;->mHandler:Landroid/os/Handler;
a=0;// 
a=0;//     iget-object v1, p0, Landroid/support/v4/content/AsyncTaskLoader;->mTask:Landroid/support/v4/content/AsyncTaskLoader$LoadTask;
a=0;// 
a=0;//     #v1=(Reference,Landroid/support/v4/content/AsyncTaskLoader$LoadTask;);
...
a=0;//     add-long/2addr v2, v4
a=0;// 
a=0;//     invoke-virtual {v0, v1, v2, v3}, Landroid/os/Handler;->postAtTime(Ljava/lang/Runnable;J)Z
a=0;// 
a=0;//     .line 197
a=0;//     :cond_1
a=0;//     :goto_0
...
a=0;// 
a=0;//     #v1=(Reference,Landroid/support/v4/content/AsyncTaskLoader$LoadTask;);
a=0;//     sget-object v2, Landroid/support/v4/content/ModernAsyncTask;->THREAD_POOL_EXECUTOR:Ljava/util/concurrent/Executor;
a=0;// 
a=0;//     #v2=(Reference,Ljava/util/concurrent/Executor;);
a=0;//     const/4 v0, 0x0
a=0;// 
a=0;//     #v0=(Null);
a=0;//     check-cast v0, [Ljava/lang/Void;
a=0;// 
a=0;//     #v0=(Reference,[Ljava/lang/Void;);
a=0;//     invoke-virtual {v1, v2, v0}, Landroid/support/v4/content/AsyncTaskLoader$LoadTask;->executeOnExecutor(Ljava/util/concurrent/Executor;[Ljava/lang/Object;)Landroid/support/v4/content/ModernAsyncTask;
a=0;// 
a=0;//     goto :goto_0
a=0;// .end method
a=0;// 
...
a=0;//     move-result-object v0
a=0;// 
a=0;//     invoke-virtual {v0}, Ljava/util/concurrent/CountDownLatch;->await()V
a=0;//     :try_end_0
