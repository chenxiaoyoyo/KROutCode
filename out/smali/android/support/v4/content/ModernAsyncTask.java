...
a=0;// 
a=0;//     #v0=(Reference,Landroid/support/v4/content/ModernAsyncTask$InternalHandler;);
a=0;//     new-instance v1, Landroid/support/v4/content/ModernAsyncTask$AsyncTaskResult;
a=0;// 
a=0;//     #v1=(UninitRef,Landroid/support/v4/content/ModernAsyncTask$AsyncTaskResult;);
...
a=0;// 
a=0;//     invoke-direct {v1, p0, v2}, Landroid/support/v4/content/ModernAsyncTask$AsyncTaskResult;-><init>(Landroid/support/v4/content/ModernAsyncTask;[Ljava/lang/Object;)V
a=0;// 
a=0;//     #v1=(Reference,Landroid/support/v4/content/ModernAsyncTask$AsyncTaskResult;);
a=0;//     invoke-virtual {v0, v4, v1}, Landroid/support/v4/content/ModernAsyncTask$InternalHandler;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;
a=0;// 
a=0;//     move-result-object v0
a=0;// 
a=0;//     .line 159
