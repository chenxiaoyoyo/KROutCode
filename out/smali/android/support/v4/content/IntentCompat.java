...
a=0;// 
a=0;//     .line 87
a=0;//     new-instance v0, Landroid/support/v4/content/IntentCompat$IntentCompatImplIcsMr1;
a=0;// 
a=0;//     #v0=(UninitRef,Landroid/support/v4/content/IntentCompat$IntentCompatImplIcsMr1;);
a=0;//     invoke-direct {v0}, Landroid/support/v4/content/IntentCompat$IntentCompatImplIcsMr1;-><init>()V
a=0;// 
a=0;//     #v0=(Reference,Landroid/support/v4/content/IntentCompat$IntentCompatImplIcsMr1;);
a=0;//     sput-object v0, Landroid/support/v4/content/IntentCompat;->IMPL:Landroid/support/v4/content/IntentCompat$IntentCompatImpl;
a=0;// 
a=0;//     .line 93
a=0;//     :goto_0
a=0;//     return-void
...
a=0;// 
a=0;//     .line 89
a=0;//     new-instance v0, Landroid/support/v4/content/IntentCompat$IntentCompatImplHC;
a=0;// 
a=0;//     #v0=(UninitRef,Landroid/support/v4/content/IntentCompat$IntentCompatImplHC;);
a=0;//     invoke-direct {v0}, Landroid/support/v4/content/IntentCompat$IntentCompatImplHC;-><init>()V
a=0;// 
a=0;//     #v0=(Reference,Landroid/support/v4/content/IntentCompat$IntentCompatImplHC;);
a=0;//     sput-object v0, Landroid/support/v4/content/IntentCompat;->IMPL:Landroid/support/v4/content/IntentCompat$IntentCompatImpl;
a=0;// 
a=0;//     goto :goto_0
a=0;// 
...
a=0;//     :cond_1
a=0;//     #v0=(Integer);
a=0;//     new-instance v0, Landroid/support/v4/content/IntentCompat$IntentCompatImplBase;
a=0;// 
a=0;//     #v0=(UninitRef,Landroid/support/v4/content/IntentCompat$IntentCompatImplBase;);
a=0;//     invoke-direct {v0}, Landroid/support/v4/content/IntentCompat$IntentCompatImplBase;-><init>()V
a=0;// 
a=0;//     #v0=(Reference,Landroid/support/v4/content/IntentCompat$IntentCompatImplBase;);
a=0;//     sput-object v0, Landroid/support/v4/content/IntentCompat;->IMPL:Landroid/support/v4/content/IntentCompat$IntentCompatImpl;
a=0;// 
a=0;//     goto :goto_0
a=0;// .end method
