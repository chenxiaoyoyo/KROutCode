...
a=0;// 
a=0;//     #v0=(Reference,Landroid/support/v4/widget/CursorFilter$CursorFilterClient;);
a=0;//     invoke-interface {v0, p1}, Landroid/support/v4/widget/CursorFilter$CursorFilterClient;->runQueryOnBackgroundThread(Ljava/lang/CharSequence;)Landroid/database/Cursor;
a=0;// 
a=0;//     move-result-object v0
a=0;// 
a=0;//     .line 52
...
a=0;// 
a=0;//     #v0=(Null);
a=0;//     iput v0, v1, Landroid/widget/Filter$FilterResults;->count:I
a=0;// 
a=0;//     .line 58
a=0;//     const/4 v0, 0x0
a=0;// 
...
a=0;// 
a=0;//     #v0=(Reference,Landroid/support/v4/widget/CursorFilter$CursorFilterClient;);
a=0;//     invoke-interface {v0}, Landroid/support/v4/widget/CursorFilter$CursorFilterClient;->getCursor()Landroid/database/Cursor;
a=0;// 
a=0;//     move-result-object v0
a=0;// 
a=0;//     .line 67
...
a=0;// 
a=0;//     iget-object v0, p2, Landroid/widget/Filter$FilterResults;->values:Ljava/lang/Object;
a=0;// 
a=0;//     check-cast v0, Landroid/database/Cursor;
a=0;// 
a=0;//     invoke-interface {v1, v0}, Landroid/support/v4/widget/CursorFilter$CursorFilterClient;->changeCursor(Landroid/database/Cursor;)V
a=0;// 
a=0;//     .line 70
a=0;//     :cond_0
a=0;//     return-void
