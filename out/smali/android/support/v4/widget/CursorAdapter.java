...
a=0;// 
a=0;//     .line 266
a=0;//     iget-object v0, p0, Landroid/support/v4/widget/CursorAdapter;->mContext:Landroid/content/Context;
a=0;// 
...
a=0;//     invoke-virtual {p0, v0, v1, p3}, Landroid/support/v4/widget/CursorAdapter;->newDropDownView(Landroid/content/Context;Landroid/database/Cursor;Landroid/view/ViewGroup;)Landroid/view/View;
a=0;// 
...
a=0;// 
a=0;//     #v1=(Reference,Landroid/database/Cursor;);
a=0;//     invoke-virtual {p0, p2, v0, v1}, Landroid/support/v4/widget/CursorAdapter;->bindView(Landroid/view/View;Landroid/content/Context;Landroid/database/Cursor;)V
a=0;// 
a=0;//     .line 273
a=0;//     :goto_0
...
a=0;//     const-string v1, "this should only be called when the cursor is valid"
a=0;// 
...
a=0;//     const-string v2, "couldn\'t move cursor to position "
a=0;// 
...
a=0;// 
a=0;//     #v1=(Reference,Landroid/database/Cursor;);
a=0;//     invoke-virtual {p0, v0, v1, p3}, Landroid/support/v4/widget/CursorAdapter;->newView(Landroid/content/Context;Landroid/database/Cursor;Landroid/view/ViewGroup;)Landroid/view/View;
a=0;// 
a=0;//     move-result-object p2
a=0;// 
a=0;//     .line 256
...
a=0;// 
a=0;//     .line 184
a=0;//     iget-object v0, p0, Landroid/support/v4/widget/CursorAdapter;->mChangeObserver:Landroid/support/v4/widget/CursorAdapter$ChangeObserver;
a=0;// 
a=0;//     #v0=(Reference,Landroid/support/v4/widget/CursorAdapter$ChangeObserver;);
a=0;//     if-eqz v0, :cond_0
a=0;// 
a=0;//     iget-object v0, p0, Landroid/support/v4/widget/CursorAdapter;->mChangeObserver:Landroid/support/v4/widget/CursorAdapter$ChangeObserver;
a=0;// 
a=0;//     invoke-interface {p2, v0}, Landroid/database/Cursor;->registerContentObserver(Landroid/database/ContentObserver;)V
a=0;// 
a=0;//     .line 185
a=0;//     :cond_0
a=0;//     iget-object v0, p0, Landroid/support/v4/widget/CursorAdapter;->mDataSetObserver:Landroid/database/DataSetObserver;
a=0;// 
a=0;//     if-eqz v0, :cond_1
a=0;// 
a=0;//     iget-object v0, p0, Landroid/support/v4/widget/CursorAdapter;->mDataSetObserver:Landroid/database/DataSetObserver;
a=0;// 
a=0;//     invoke-interface {p2, v0}, Landroid/database/Cursor;->registerDataSetObserver(Landroid/database/DataSetObserver;)V
a=0;// 
a=0;//     .line 187
a=0;//     :cond_1
a=0;//     #v0=(Conflicted);
