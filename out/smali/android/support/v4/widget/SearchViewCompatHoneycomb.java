...
a=0;// 
a=0;//     .line 47
a=0;//     invoke-virtual {p0}, Landroid/widget/SearchView;->getContext()Landroid/content/Context;
a=0;// 
a=0;//     move-result-object v0
a=0;// 
...
a=0;//     move-result-object v0
a=0;// 
a=0;//     invoke-virtual {p0, v0}, Landroid/widget/SearchView;->setSearchableInfo(Landroid/app/SearchableInfo;)V
a=0;// 
a=0;//     .line 50
a=0;//     return-void
a=0;// .end method
