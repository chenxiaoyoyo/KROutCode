...
a=0;// 
a=0;//     :goto_0
a=0;//     #v0=(Reference,Landroid/support/v4/app/FragmentTabHost$TabInfo;);v1=(Reference,Landroid/support/v4/app/FragmentTabHost$TabInfo;);v2=(Integer);v3=(Conflicted);
a=0;//     iget-object v0, p0, Landroid/support/v4/app/FragmentTabHost;->mTabs:Ljava/util/ArrayList;
a=0;// 
...
a=0;// 
a=0;//     check-cast v0, Landroid/support/v4/app/FragmentTabHost$TabInfo;
a=0;// 
a=0;//     .line 321
a=0;//     invoke-static {v0}, Landroid/support/v4/app/FragmentTabHost$TabInfo;->access$200(Landroid/support/v4/app/FragmentTabHost$TabInfo;)Ljava/lang/String;
a=0;// 
...
a=0;//     iget-object v0, p0, Landroid/support/v4/app/FragmentTabHost;->mLastTab:Landroid/support/v4/app/FragmentTabHost$TabInfo;
a=0;// 
a=0;//     #v0=(Reference,Landroid/support/v4/app/FragmentTabHost$TabInfo;);
...
a=0;// 
a=0;//     .line 330
a=0;//     iget-object v0, p0, Landroid/support/v4/app/FragmentTabHost;->mFragmentManager:Landroid/support/v4/app/FragmentManager;
a=0;// 
...
a=0;//     iget-object v0, p0, Landroid/support/v4/app/FragmentTabHost;->mLastTab:Landroid/support/v4/app/FragmentTabHost$TabInfo;
a=0;// 
a=0;//     invoke-static {v0}, Landroid/support/v4/app/FragmentTabHost$TabInfo;->access$100(Landroid/support/v4/app/FragmentTabHost$TabInfo;)Landroid/support/v4/app/Fragment;
a=0;// 
a=0;//     move-result-object v0
a=0;// 
a=0;//     if-eqz v0, :cond_3
...
a=0;//     move-result-object v0
a=0;// 
a=0;//     invoke-virtual {p2, v0}, Landroid/support/v4/app/FragmentTransaction;->detach(Landroid/support/v4/app/Fragment;)Landroid/support/v4/app/FragmentTransaction;
a=0;// 
a=0;//     .line 337
a=0;//     :cond_3
...
a=0;// 
a=0;//     .line 339
a=0;//     iget-object v0, p0, Landroid/support/v4/app/FragmentTabHost;->mContext:Landroid/content/Context;
a=0;// 
...
a=0;//     invoke-static {v0, v2, v3}, Landroid/support/v4/app/Fragment;->instantiate(Landroid/content/Context;Ljava/lang/String;Landroid/os/Bundle;)Landroid/support/v4/app/Fragment;
a=0;// 
a=0;//     move-result-object v0
a=0;// 
a=0;//     invoke-static {v1, v0}, Landroid/support/v4/app/FragmentTabHost$TabInfo;->access$102(Landroid/support/v4/app/FragmentTabHost$TabInfo;Landroid/support/v4/app/Fragment;)Landroid/support/v4/app/Fragment;
a=0;// 
a=0;//     .line 341
...
a=0;//     move-result-object v3
a=0;// 
a=0;//     invoke-virtual {p2, v0, v2, v3}, Landroid/support/v4/app/FragmentTransaction;->add(ILandroid/support/v4/app/Fragment;Ljava/lang/String;)Landroid/support/v4/app/FragmentTransaction;
a=0;// 
a=0;//     .line 347
a=0;//     :cond_4
a=0;//     :goto_2
...
a=0;//     move-result-object v0
a=0;// 
a=0;//     invoke-virtual {p2, v0}, Landroid/support/v4/app/FragmentTransaction;->attach(Landroid/support/v4/app/Fragment;)Landroid/support/v4/app/FragmentTransaction;
a=0;// 
a=0;//     goto :goto_2
a=0;// 
a=0;//     :cond_7
...
a=0;// 
a=0;//     #v0=(Reference,[I);
a=0;//     const v1, 0x10100f3
a=0;// 
a=0;//     #v1=(Integer);
a=0;//     aput v1, v0, v4
a=0;// 
a=0;//     invoke-virtual {p1, p2, v0, v4, v4}, Landroid/content/Context;->obtainStyledAttributes(Landroid/util/AttributeSet;[III)Landroid/content/res/TypedArray;
a=0;// 
a=0;//     move-result-object v0
a=0;// 
a=0;//     .line 142
a=0;//     invoke-virtual {v0, v4, v4}, Landroid/content/res/TypedArray;->getResourceId(II)I
a=0;// 
a=0;//     move-result v1
a=0;// 
...
a=0;// 
a=0;//     .line 149
a=0;//     invoke-virtual {p0, v3}, Landroid/support/v4/app/FragmentTabHost;->findViewById(I)Landroid/view/View;
a=0;// 
a=0;//     move-result-object v0
a=0;// 
a=0;//     if-nez v0, :cond_0
...
a=0;//     invoke-virtual {v0, v2}, Landroid/widget/LinearLayout;->setOrientation(I)V
a=0;// 
a=0;//     .line 152
a=0;//     new-instance v1, Landroid/widget/FrameLayout$LayoutParams;
a=0;// 
a=0;//     #v1=(UninitRef,Landroid/widget/FrameLayout$LayoutParams;);
a=0;//     invoke-direct {v1, v5, v5}, Landroid/widget/FrameLayout$LayoutParams;-><init>(II)V
a=0;// 
a=0;//     #v1=(Reference,Landroid/widget/FrameLayout$LayoutParams;);
a=0;//     invoke-virtual {p0, v0, v1}, Landroid/support/v4/app/FragmentTabHost;->addView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V
a=0;// 
a=0;//     .line 156
a=0;//     new-instance v1, Landroid/widget/TabWidget;
a=0;// 
a=0;//     #v1=(UninitRef,Landroid/widget/TabWidget;);
a=0;//     invoke-direct {v1, p1}, Landroid/widget/TabWidget;-><init>(Landroid/content/Context;)V
a=0;// 
a=0;//     .line 157
a=0;//     #v1=(Reference,Landroid/widget/TabWidget;);
a=0;//     invoke-virtual {v1, v3}, Landroid/widget/TabWidget;->setId(I)V
a=0;// 
a=0;//     .line 158
a=0;//     invoke-virtual {v1, v4}, Landroid/widget/TabWidget;->setOrientation(I)V
a=0;// 
a=0;//     .line 159
...
a=0;// 
a=0;//     #v3=(Byte);
a=0;//     invoke-direct {v2, v5, v3, v6}, Landroid/widget/LinearLayout$LayoutParams;-><init>(IIF)V
a=0;// 
...
a=0;//     const v2, 0x1020011
a=0;// 
a=0;//     #v2=(Integer);
a=0;//     invoke-virtual {v1, v2}, Landroid/widget/FrameLayout;->setId(I)V
a=0;// 
a=0;//     .line 165
a=0;//     new-instance v2, Landroid/widget/LinearLayout$LayoutParams;
a=0;// 
a=0;//     #v2=(UninitRef,Landroid/widget/LinearLayout$LayoutParams;);
a=0;//     invoke-direct {v2, v4, v4, v6}, Landroid/widget/LinearLayout$LayoutParams;-><init>(IIF)V
a=0;// 
a=0;//     #v2=(Reference,Landroid/widget/LinearLayout$LayoutParams;);
a=0;//     invoke-virtual {v0, v1, v2}, Landroid/widget/LinearLayout;->addView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V
a=0;// 
...
a=0;// 
a=0;//     .line 168
a=0;//     iget-object v2, p0, Landroid/support/v4/app/FragmentTabHost;->mRealTabContent:Landroid/widget/FrameLayout;
a=0;// 
a=0;//     iget v3, p0, Landroid/support/v4/app/FragmentTabHost;->mContainerId:I
a=0;// 
a=0;//     #v3=(Integer);
a=0;//     invoke-virtual {v2, v3}, Landroid/widget/FrameLayout;->setId(I)V
a=0;// 
a=0;//     .line 169
a=0;//     new-instance v2, Landroid/widget/LinearLayout$LayoutParams;
a=0;// 
...
a=0;// 
a=0;//     invoke-direct {v2, v5, v4, v3}, Landroid/widget/LinearLayout$LayoutParams;-><init>(IIF)V
a=0;// 
a=0;//     #v2=(Reference,Landroid/widget/LinearLayout$LayoutParams;);
a=0;//     invoke-virtual {v0, v1, v2}, Landroid/widget/LinearLayout;->addView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V
a=0;// 
...
a=0;//     .prologue
a=0;//     .line 223
a=0;//     new-instance v0, Landroid/support/v4/app/FragmentTabHost$DummyTabFactory;
a=0;// 
a=0;//     #v0=(UninitRef,Landroid/support/v4/app/FragmentTabHost$DummyTabFactory;);
a=0;//     iget-object v1, p0, Landroid/support/v4/app/FragmentTabHost;->mContext:Landroid/content/Context;
a=0;// 
a=0;//     #v1=(Reference,Landroid/content/Context;);
a=0;//     invoke-direct {v0, v1}, Landroid/support/v4/app/FragmentTabHost$DummyTabFactory;-><init>(Landroid/content/Context;)V
a=0;// 
a=0;//     #v0=(Reference,Landroid/support/v4/app/FragmentTabHost$DummyTabFactory;);
a=0;//     invoke-virtual {p1, v0}, Landroid/widget/TabHost$TabSpec;->setContent(Landroid/widget/TabHost$TabContentFactory;)Landroid/widget/TabHost$TabSpec;
a=0;// 
a=0;//     .line 224
...
a=0;//     invoke-direct {v1, v0, p2, p3}, Landroid/support/v4/app/FragmentTabHost$TabInfo;-><init>(Ljava/lang/String;Ljava/lang/Class;Landroid/os/Bundle;)V
a=0;// 
a=0;//     .line 228
a=0;//     #v1=(Reference,Landroid/support/v4/app/FragmentTabHost$TabInfo;);
a=0;//     iget-boolean v2, p0, Landroid/support/v4/app/FragmentTabHost;->mAttached:Z
a=0;// 
a=0;//     #v2=(Boolean);
a=0;//     if-eqz v2, :cond_0
a=0;// 
a=0;//     .line 232
a=0;//     iget-object v2, p0, Landroid/support/v4/app/FragmentTabHost;->mFragmentManager:Landroid/support/v4/app/FragmentManager;
a=0;// 
a=0;//     #v2=(Reference,Landroid/support/v4/app/FragmentManager;);
a=0;//     invoke-virtual {v2, v0}, Landroid/support/v4/app/FragmentManager;->findFragmentByTag(Ljava/lang/String;)Landroid/support/v4/app/Fragment;
a=0;// 
a=0;//     move-result-object v0
a=0;// 
a=0;//     invoke-static {v1, v0}, Landroid/support/v4/app/FragmentTabHost$TabInfo;->access$102(Landroid/support/v4/app/FragmentTabHost$TabInfo;Landroid/support/v4/app/Fragment;)Landroid/support/v4/app/Fragment;
...
a=0;//     move-result-object v0
a=0;// 
a=0;//     invoke-virtual {v0}, Landroid/support/v4/app/Fragment;->isDetached()Z
a=0;// 
a=0;//     move-result v0
a=0;// 
a=0;//     #v0=(Boolean);
...
a=0;//     move-result-object v2
a=0;// 
a=0;//     invoke-virtual {v0, v2}, Landroid/support/v4/app/FragmentTransaction;->detach(Landroid/support/v4/app/Fragment;)Landroid/support/v4/app/FragmentTransaction;
a=0;// 
a=0;//     .line 236
...
a=0;// 
a=0;//     :goto_0
a=0;//     #v0=(Integer);v1=(Reference,Landroid/support/v4/app/FragmentTransaction;);v2=(Integer);v4=(Conflicted);v5=(Conflicted);
a=0;//     iget-object v0, p0, Landroid/support/v4/app/FragmentTabHost;->mTabs:Ljava/util/ArrayList;
a=0;// 
a=0;//     #v0=(Reference,Ljava/util/ArrayList;);
a=0;//     invoke-virtual {v0}, Ljava/util/ArrayList;->size()I
...
a=0;// 
a=0;//     invoke-static {v0, v4}, Landroid/support/v4/app/FragmentTabHost$TabInfo;->access$102(Landroid/support/v4/app/FragmentTabHost$TabInfo;Landroid/support/v4/app/Fragment;)Landroid/support/v4/app/Fragment;
a=0;// 
a=0;//     .line 256
a=0;//     invoke-static {v0}, Landroid/support/v4/app/FragmentTabHost$TabInfo;->access$100(Landroid/support/v4/app/FragmentTabHost$TabInfo;)Landroid/support/v4/app/Fragment;
a=0;// 
...
a=0;// 
a=0;//     .line 261
a=0;//     iput-object v0, p0, Landroid/support/v4/app/FragmentTabHost;->mLastTab:Landroid/support/v4/app/FragmentTabHost$TabInfo;
a=0;// 
a=0;//     .line 253
a=0;//     :cond_0
a=0;//     :goto_1
...
a=0;//     .line 265
a=0;//     :cond_1
a=0;//     #v0=(Reference,Landroid/support/v4/app/FragmentTabHost$TabInfo;);v4=(Boolean);
a=0;//     if-nez v1, :cond_2
a=0;// 
a=0;//     .line 266
a=0;//     iget-object v1, p0, Landroid/support/v4/app/FragmentTabHost;->mFragmentManager:Landroid/support/v4/app/FragmentManager;
a=0;// 
...
a=0;//     move-result-object v0
a=0;// 
a=0;//     invoke-virtual {v1, v0}, Landroid/support/v4/app/FragmentTransaction;->detach(Landroid/support/v4/app/Fragment;)Landroid/support/v4/app/FragmentTransaction;
a=0;// 
a=0;//     goto :goto_1
a=0;// 
a=0;//     .line 275
...
a=0;// 
a=0;//     .line 276
a=0;//     invoke-direct {p0, v3, v1}, Landroid/support/v4/app/FragmentTabHost;->doTabChanged(Ljava/lang/String;Landroid/support/v4/app/FragmentTransaction;)Landroid/support/v4/app/FragmentTransaction;
a=0;// 
a=0;//     move-result-object v0
a=0;// 
a=0;//     .line 277
...
a=0;// 
a=0;//     .line 301
a=0;//     iget-object v0, p1, Landroid/support/v4/app/FragmentTabHost$SavedState;->curTab:Ljava/lang/String;
a=0;// 
...
a=0;//     move-result-object v0
a=0;// 
a=0;//     iput-object v0, v1, Landroid/support/v4/app/FragmentTabHost$SavedState;->curTab:Ljava/lang/String;
a=0;// 
a=0;//     .line 294
...
a=0;//     .prologue
a=0;//     .line 306
a=0;//     iget-boolean v0, p0, Landroid/support/v4/app/FragmentTabHost;->mAttached:Z
a=0;// 
a=0;//     #v0=(Boolean);
a=0;//     if-eqz v0, :cond_0
a=0;// 
...
a=0;// 
a=0;//     #v0=(Null);
a=0;//     invoke-direct {p0, p1, v0}, Landroid/support/v4/app/FragmentTabHost;->doTabChanged(Ljava/lang/String;Landroid/support/v4/app/FragmentTransaction;)Landroid/support/v4/app/FragmentTransaction;
a=0;// 
a=0;//     move-result-object v0
a=0;// 
a=0;//     .line 308
...
a=0;//     :cond_0
a=0;//     #v0=(Conflicted);
a=0;//     iget-object v0, p0, Landroid/support/v4/app/FragmentTabHost;->mOnTabChangeListener:Landroid/widget/TabHost$OnTabChangeListener;
a=0;// 
