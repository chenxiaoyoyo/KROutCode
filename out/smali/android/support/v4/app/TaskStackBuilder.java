...
a=0;// 
a=0;//     .line 180
a=0;//     iget-object v0, p0, Landroid/support/v4/app/TaskStackBuilder;->mSourceContext:Landroid/content/Context;
a=0;// 
a=0;//     invoke-virtual {v0}, Landroid/content/Context;->getPackageManager()Landroid/content/pm/PackageManager;
a=0;// 
a=0;//     move-result-object v0
a=0;// 
a=0;//     invoke-virtual {p1, v0}, Landroid/content/Intent;->resolveActivity(Landroid/content/pm/PackageManager;)Landroid/content/ComponentName;
a=0;// 
a=0;//     move-result-object v0
a=0;// 
a=0;//     .line 182
...
a=0;//     .line 198
a=0;//     #v0=(Null);
a=0;//     instance-of v1, p1, Landroid/support/v4/app/TaskStackBuilder$SupportParentable;
a=0;// 
a=0;//     #v1=(Boolean);
...
a=0;//     check-cast v0, Landroid/support/v4/app/TaskStackBuilder$SupportParentable;
a=0;// 
a=0;//     invoke-interface {v0}, Landroid/support/v4/app/TaskStackBuilder$SupportParentable;->getSupportParentActivityIntent()Landroid/content/Intent;
a=0;// 
a=0;//     move-result-object v0
a=0;// 
a=0;//     .line 201
...
a=0;//     move-result-object v0
a=0;// 
a=0;//     invoke-virtual {v1, v0}, Landroid/content/Intent;->resolveActivity(Landroid/content/pm/PackageManager;)Landroid/content/ComponentName;
a=0;// 
a=0;//     move-result-object v0
a=0;// 
a=0;//     .line 212
...
a=0;// 
a=0;//     .line 213
a=0;//     invoke-virtual {p0, v1}, Landroid/support/v4/app/TaskStackBuilder;->addNextIntent(Landroid/content/Intent;)Landroid/support/v4/app/TaskStackBuilder;
a=0;// 
a=0;//     .line 215
a=0;//     :cond_2
a=0;//     return-object p0
...
a=0;//     iget-object v0, p0, Landroid/support/v4/app/TaskStackBuilder;->mSourceContext:Landroid/content/Context;
a=0;// 
a=0;//     invoke-static {v0, p1}, Landroid/support/v4/app/NavUtils;->getParentActivityIntent(Landroid/content/Context;Landroid/content/ComponentName;)Landroid/content/Intent;
a=0;// 
a=0;//     move-result-object v0
a=0;// 
a=0;//     .line 241
...
a=0;//     invoke-virtual {v2, v1, v0}, Ljava/util/ArrayList;->add(ILjava/lang/Object;)V
a=0;// 
a=0;//     .line 243
...
a=0;//     move-result-object v0
a=0;// 
a=0;//     invoke-static {v2, v0}, Landroid/support/v4/app/NavUtils;->getParentActivityIntent(Landroid/content/Context;Landroid/content/ComponentName;)Landroid/content/Intent;
a=0;//     :try_end_0
...
a=0;// 
a=0;//     .line 246
a=0;//     const-string v1, "TaskStackBuilder"
a=0;// 
a=0;//     #v1=(Reference,Ljava/lang/String;);
a=0;//     const-string v2, "Bad ComponentName while traversing activity parent metadata"
a=0;// 
...
a=0;// 
a=0;//     #v0=(Integer);
a=0;//     new-array v2, v0, [Landroid/content/Intent;
a=0;// 
a=0;//     .line 383
...
a=0;//     .line 391
a=0;//     :goto_0
a=0;//     #v0=(Reference,[Landroid/content/Intent;);v1=(Conflicted);v3=(Reference,Landroid/content/Intent;);
a=0;//     return-object v0
a=0;// 
a=0;//     .line 385
a=0;//     :cond_0
a=0;//     #v0=(Integer);v1=(Uninit);v3=(Null);
...
a=0;// 
a=0;//     :goto_1
a=0;//     #v0=(Integer);v1=(Integer);v3=(Reference,Landroid/content/Intent;);
a=0;//     array-length v0, v2
a=0;// 
...
a=0;//     check-cast v0, Landroid/content/Intent;
a=0;// 
a=0;//     invoke-direct {v3, v0}, Landroid/content/Intent;-><init>(Landroid/content/Intent;)V
a=0;// 
...
a=0;// 
a=0;//     #v0=(UninitRef,Ljava/lang/IllegalStateException;);
a=0;//     const-string v1, "No intents added to TaskStackBuilder; cannot startActivities"
a=0;// 
a=0;//     #v1=(Reference,Ljava/lang/String;);
a=0;//     invoke-direct {v0, v1}, Ljava/lang/IllegalStateException;-><init>(Ljava/lang/String;)V
a=0;// 
...
a=0;//     iget-object v1, p0, Landroid/support/v4/app/TaskStackBuilder;->mSourceContext:Landroid/content/Context;
a=0;// 
a=0;//     invoke-static {v1, v0, p1}, Landroid/support/v4/content/ContextCompat;->startActivities(Landroid/content/Context;[Landroid/content/Intent;Landroid/os/Bundle;)Z
a=0;// 
a=0;//     move-result v1
a=0;// 
a=0;//     #v1=(Boolean);
