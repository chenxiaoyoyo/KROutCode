...
a=0;//     const-string v1, "Content view not yet created"
a=0;// 
...
a=0;//     :cond_1
a=0;//     #v1=(Uninit);
a=0;//     instance-of v1, v0, Landroid/widget/ListView;
a=0;// 
a=0;//     #v1=(Boolean);
...
a=0;// 
a=0;//     iput-object v0, p0, Landroid/support/v4/app/ListFragment;->mList:Landroid/widget/ListView;
a=0;// 
a=0;//     .line 360
a=0;//     :cond_2
a=0;//     :goto_1
...
a=0;// 
a=0;//     #v0=(Reference,Landroid/widget/ListView;);
a=0;//     iget-object v1, p0, Landroid/support/v4/app/ListFragment;->mOnClickListener:Landroid/widget/AdapterView$OnItemClickListener;
a=0;// 
...
a=0;// 
a=0;//     #v1=(Null);
a=0;//     iput-object v1, p0, Landroid/support/v4/app/ListFragment;->mAdapter:Landroid/widget/ListAdapter;
a=0;// 
a=0;//     .line 365
...
a=0;// 
a=0;//     iput-object v1, p0, Landroid/support/v4/app/ListFragment;->mStandardEmptyView:Landroid/widget/TextView;
a=0;// 
a=0;//     .line 334
...
a=0;// 
a=0;//     #v1=(Reference,Landroid/view/View;);
a=0;//     iput-object v1, p0, Landroid/support/v4/app/ListFragment;->mEmptyView:Landroid/view/View;
a=0;// 
a=0;//     .line 339
a=0;//     :goto_3
a=0;//     #v2=(Conflicted);
a=0;//     const v1, 0xff0002
a=0;// 
a=0;//     #v1=(Integer);
a=0;//     invoke-virtual {v0, v1}, Landroid/view/View;->findViewById(I)Landroid/view/View;
a=0;// 
...
a=0;// 
a=0;//     #v1=(Reference,Landroid/view/View;);
a=0;//     iput-object v1, p0, Landroid/support/v4/app/ListFragment;->mProgressContainer:Landroid/view/View;
a=0;// 
a=0;//     .line 340
a=0;//     const v1, 0xff0003
a=0;// 
a=0;//     #v1=(Integer);
a=0;//     invoke-virtual {v0, v1}, Landroid/view/View;->findViewById(I)Landroid/view/View;
a=0;// 
...
a=0;// 
a=0;//     #v1=(Reference,Landroid/view/View;);
a=0;//     iput-object v1, p0, Landroid/support/v4/app/ListFragment;->mListContainer:Landroid/view/View;
a=0;// 
a=0;//     .line 341
...
a=0;//     const-string v1, "Your content must have a ListView whose id attribute is \'android.R.id.list\'"
a=0;// 
a=0;//     #v1=(Reference,Ljava/lang/String;);
...
a=0;// 
a=0;//     #v0=(UninitRef,Ljava/lang/RuntimeException;);
a=0;//     const-string v1, "Content has view with id attribute \'android.R.id.list\' that is not a ListView class"
a=0;// 
a=0;//     #v1=(Reference,Ljava/lang/String;);
a=0;//     invoke-direct {v0, v1}, Ljava/lang/RuntimeException;-><init>(Ljava/lang/String;)V
a=0;// 
...
a=0;// 
a=0;//     .line 353
a=0;//     iget-object v0, p0, Landroid/support/v4/app/ListFragment;->mEmptyView:Landroid/view/View;
a=0;// 
...
a=0;//     iget-object v0, p0, Landroid/support/v4/app/ListFragment;->mList:Landroid/widget/ListView;
a=0;// 
a=0;//     iget-object v1, p0, Landroid/support/v4/app/ListFragment;->mEmptyView:Landroid/view/View;
a=0;// 
a=0;//     #v1=(Reference,Landroid/view/View;);
...
a=0;// 
a=0;//     iget-object v1, p0, Landroid/support/v4/app/ListFragment;->mEmptyText:Ljava/lang/CharSequence;
a=0;// 
...
a=0;// 
a=0;//     .line 370
a=0;//     invoke-direct {p0, v3, v3}, Landroid/support/v4/app/ListFragment;->setListShown(ZZ)V
a=0;// 
a=0;//     goto/16 :goto_2
a=0;// .end method
a=0;// 
...
a=0;// 
a=0;//     #v3=(Integer);
a=0;//     invoke-virtual {v2, v3}, Landroid/widget/LinearLayout;->setId(I)V
a=0;// 
a=0;//     .line 99
a=0;//     const/4 v3, 0x1
a=0;// 
...
a=0;// 
a=0;//     .line 101
a=0;//     invoke-virtual {v2, v8}, Landroid/widget/LinearLayout;->setGravity(I)V
a=0;// 
a=0;//     .line 103
...
a=0;// 
a=0;//     #v4=(Null);
a=0;//     const v5, 0x101007a
a=0;// 
a=0;//     #v5=(Integer);
a=0;//     invoke-direct {v3, v0, v4, v5}, Landroid/widget/ProgressBar;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
a=0;// 
a=0;//     .line 105
...
a=0;//     invoke-direct {v3, v6, v6}, Landroid/widget/FrameLayout$LayoutParams;-><init>(II)V
a=0;// 
a=0;//     #v3=(Reference,Landroid/widget/FrameLayout$LayoutParams;);
a=0;//     invoke-virtual {v1, v2, v3}, Landroid/widget/FrameLayout;->addView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V
a=0;// 
a=0;//     .line 113
...
a=0;//     const v0, 0xff0003
a=0;// 
a=0;//     #v0=(Integer);
a=0;//     invoke-virtual {v2, v0}, Landroid/widget/FrameLayout;->setId(I)V
a=0;// 
a=0;//     .line 116
...
a=0;// 
a=0;//     invoke-direct {v0, v3}, Landroid/widget/TextView;-><init>(Landroid/content/Context;)V
a=0;// 
a=0;//     .line 117
...
a=0;// 
a=0;//     #v3=(Integer);
a=0;//     invoke-virtual {v0, v3}, Landroid/widget/TextView;->setId(I)V
a=0;// 
a=0;//     .line 118
a=0;//     invoke-virtual {v0, v8}, Landroid/widget/TextView;->setGravity(I)V
a=0;// 
a=0;//     .line 119
a=0;//     new-instance v3, Landroid/widget/FrameLayout$LayoutParams;
a=0;// 
...
a=0;// 
a=0;//     #v3=(Reference,Landroid/widget/FrameLayout$LayoutParams;);
a=0;//     invoke-virtual {v2, v0, v3}, Landroid/widget/FrameLayout;->addView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V
a=0;// 
a=0;//     .line 122
...
a=0;//     move-result-object v3
a=0;// 
a=0;//     invoke-direct {v0, v3}, Landroid/widget/ListView;-><init>(Landroid/content/Context;)V
a=0;// 
a=0;//     .line 123
a=0;//     #v0=(Reference,Landroid/widget/ListView;);
...
a=0;// 
a=0;//     #v3=(Integer);
a=0;//     invoke-virtual {v0, v3}, Landroid/widget/ListView;->setId(I)V
a=0;// 
a=0;//     .line 124
a=0;//     const/4 v3, 0x0
a=0;// 
a=0;//     #v3=(Null);
a=0;//     invoke-virtual {v0, v3}, Landroid/widget/ListView;->setDrawSelectorOnTop(Z)V
a=0;// 
a=0;//     .line 125
a=0;//     new-instance v3, Landroid/widget/FrameLayout$LayoutParams;
a=0;// 
...
a=0;//     invoke-direct {v0, v6, v6}, Landroid/widget/FrameLayout$LayoutParams;-><init>(II)V
a=0;// 
a=0;//     #v0=(Reference,Landroid/widget/FrameLayout$LayoutParams;);
a=0;//     invoke-virtual {v1, v2, v0}, Landroid/widget/FrameLayout;->addView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V
a=0;// 
a=0;//     .line 133
a=0;//     new-instance v0, Landroid/widget/FrameLayout$LayoutParams;
a=0;// 
...
a=0;// 
a=0;//     :cond_2
a=0;//     #v0=(Reference,Landroid/widget/ListAdapter;);v2=(Null);v3=(Uninit);
a=0;//     move v0, v2
a=0;// 
a=0;//     .line 179
a=0;//     #v0=(Null);
