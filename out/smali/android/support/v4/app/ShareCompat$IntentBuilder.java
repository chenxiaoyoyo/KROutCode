...
a=0;//     invoke-virtual {p2, v3}, Ljava/util/ArrayList;->toArray([Ljava/lang/Object;)[Ljava/lang/Object;
a=0;// 
a=0;//     .line 348
...
a=0;// 
a=0;//     #v4=(Integer);
a=0;//     invoke-static {v2, v1, v3, v4, v0}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V
a=0;// 
a=0;//     .line 351
a=0;//     :cond_0
a=0;//     #v4=(Conflicted);
...
a=0;//     invoke-virtual {v2, p1}, Landroid/content/Intent;->getStringArrayExtra(Ljava/lang/String;)[Ljava/lang/String;
a=0;// 
...
a=0;// 
a=0;//     invoke-static {v3, v1, v4, v1, v0}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V
a=0;// 
a=0;//     .line 361
a=0;//     :cond_0
...
a=0;// 
a=0;//     #v3=(Integer);
a=0;//     invoke-static {p2, v1, v4, v0, v3}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V
a=0;// 
a=0;//     .line 362
a=0;//     invoke-virtual {v2, p1, v4}, Landroid/content/Intent;->putExtra(Ljava/lang/String;[Ljava/lang/String;)Landroid/content/Intent;
a=0;// 
a=0;//     .line 363
a=0;//     return-void
a=0;// 
a=0;//     :cond_1
a=0;//     #v0=(Uninit);v3=(Reference,[Ljava/lang/String;);v4=(Uninit);
a=0;//     move v0, v1
a=0;// 
a=0;//     .line 358
a=0;//     #v0=(Null);
...
a=0;//     :cond_2
a=0;//     #v2=(Conflicted);
a=0;//     iget-object v0, p0, Landroid/support/v4/app/ShareCompat$IntentBuilder;->mStreams:Ljava/util/ArrayList;
a=0;// 
a=0;//     invoke-virtual {v0, p1}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z
a=0;// 
a=0;//     goto :goto_0
...
a=0;//     .line 296
a=0;//     #v6=(Null);
a=0;//     iget-object v1, p0, Landroid/support/v4/app/ShareCompat$IntentBuilder;->mToAddresses:Ljava/util/ArrayList;
a=0;// 
a=0;//     #v1=(Reference,Ljava/util/ArrayList;);
...
a=0;//     invoke-direct {p0, v1, v3}, Landroid/support/v4/app/ShareCompat$IntentBuilder;->combineArrayExtra(Ljava/lang/String;Ljava/util/ArrayList;)V
a=0;// 
a=0;//     .line 298
...
a=0;//     :cond_0
a=0;//     #v3=(Conflicted);
a=0;//     iget-object v1, p0, Landroid/support/v4/app/ShareCompat$IntentBuilder;->mCcAddresses:Ljava/util/ArrayList;
a=0;// 
...
a=0;//     :cond_1
a=0;//     #v3=(Conflicted);
a=0;//     iget-object v1, p0, Landroid/support/v4/app/ShareCompat$IntentBuilder;->mBccAddresses:Ljava/util/ArrayList;
a=0;// 
...
a=0;// 
a=0;//     #v4=(Reference,Ljava/lang/String;);
a=0;//     invoke-virtual {v0, v4}, Landroid/content/Intent;->setAction(Ljava/lang/String;)Landroid/content/Intent;
a=0;// 
a=0;//     .line 317
a=0;//     iget-object v0, p0, Landroid/support/v4/app/ShareCompat$IntentBuilder;->mStreams:Ljava/util/ArrayList;
a=0;// 
...
a=0;// 
a=0;//     const-string v5, "android.intent.extra.STREAM"
a=0;// 
...
a=0;// 
a=0;//     invoke-virtual {v4, v5, v0}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Landroid/os/Parcelable;)Landroid/content/Intent;
a=0;// 
a=0;//     .line 322
a=0;//     :goto_1
a=0;//     #v2=(Reference,Ljava/lang/String;);v5=(Conflicted);
...
a=0;// 
a=0;//     invoke-virtual {v0, v1, v2}, Landroid/content/Intent;->putParcelableArrayListExtra(Ljava/lang/String;Ljava/util/ArrayList;)Landroid/content/Intent;
a=0;// 
a=0;//     .line 336
a=0;//     :cond_4
a=0;//     :goto_2
...
a=0;// 
a=0;//     :cond_5
a=0;//     #v0=(One);v2=(Null);v3=(Conflicted);v4=(Uninit);v5=(Uninit);
a=0;//     move v1, v2
a=0;// 
a=0;//     .line 310
a=0;//     #v1=(Null);
...
a=0;//     .line 320
a=0;//     :cond_6
a=0;//     #v0=(Conflicted);v1=(Boolean);v3=(Boolean);v4=(Reference,Ljava/lang/String;);
a=0;//     iget-object v0, p0, Landroid/support/v4/app/ShareCompat$IntentBuilder;->mIntent:Landroid/content/Intent;
a=0;// 
a=0;//     #v0=(Reference,Landroid/content/Intent;);
a=0;//     const-string v2, "android.intent.extra.STREAM"
a=0;// 
a=0;//     #v2=(Reference,Ljava/lang/String;);
a=0;//     invoke-virtual {v0, v2}, Landroid/content/Intent;->removeExtra(Ljava/lang/String;)V
a=0;// 
a=0;//     goto :goto_1
a=0;// 
a=0;//     .line 332
a=0;//     :cond_7
a=0;//     #v0=(Conflicted);v1=(Reference,Ljava/lang/String;);v4=(Conflicted);v5=(Conflicted);
a=0;//     iget-object v0, p0, Landroid/support/v4/app/ShareCompat$IntentBuilder;->mIntent:Landroid/content/Intent;
a=0;// 
a=0;//     #v0=(Reference,Landroid/content/Intent;);
a=0;//     const-string v1, "android.intent.extra.STREAM"
a=0;// 
a=0;//     invoke-virtual {v0, v1}, Landroid/content/Intent;->removeExtra(Ljava/lang/String;)V
a=0;// 
a=0;//     goto :goto_2
a=0;// .end method
a=0;// 
