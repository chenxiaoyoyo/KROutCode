...
a=0;//     check-cast v2, Landroid/support/v4/app/NotificationCompat$Action;
a=0;// 
a=0;//     .line 123
a=0;//     iget v4, v2, Landroid/support/v4/app/NotificationCompat$Action;->icon:I
a=0;// 
a=0;//     #v4=(Integer);
a=0;//     iget-object v5, v2, Landroid/support/v4/app/NotificationCompat$Action;->title:Ljava/lang/CharSequence;
a=0;// 
a=0;//     iget-object v2, v2, Landroid/support/v4/app/NotificationCompat$Action;->actionIntent:Landroid/app/PendingIntent;
a=0;// 
a=0;//     invoke-virtual {v1, v4, v5, v2}, Landroid/support/v4/app/NotificationCompatJellybean;->addAction(ILjava/lang/CharSequence;Landroid/app/PendingIntent;)V
a=0;// 
a=0;//     goto :goto_0
a=0;// 
a=0;//     .line 125
...
a=0;// 
a=0;//     #v2=(Reference,Landroid/support/v4/app/NotificationCompat$Style;);
a=0;//     check-cast v2, Landroid/support/v4/app/NotificationCompat$BigTextStyle;
a=0;// 
a=0;//     .line 128
a=0;//     iget-object v3, v2, Landroid/support/v4/app/NotificationCompat$BigTextStyle;->mBigContentTitle:Ljava/lang/CharSequence;
a=0;// 
a=0;//     iget-boolean v4, v2, Landroid/support/v4/app/NotificationCompat$BigTextStyle;->mSummaryTextSet:Z
a=0;// 
a=0;//     #v4=(Boolean);
a=0;//     iget-object v5, v2, Landroid/support/v4/app/NotificationCompat$BigTextStyle;->mSummaryText:Ljava/lang/CharSequence;
a=0;// 
a=0;//     iget-object v2, v2, Landroid/support/v4/app/NotificationCompat$BigTextStyle;->mBigText:Ljava/lang/CharSequence;
a=0;// 
a=0;//     invoke-virtual {v1, v3, v4, v5, v2}, Landroid/support/v4/app/NotificationCompatJellybean;->addBigTextStyle(Ljava/lang/CharSequence;ZLjava/lang/CharSequence;Ljava/lang/CharSequence;)V
a=0;// 
a=0;//     .line 148
a=0;//     :cond_1
a=0;//     :goto_1
a=0;//     #v2=(Conflicted);v3=(Conflicted);v4=(Conflicted);v7=(Conflicted);
...
a=0;//     .line 132
a=0;//     :cond_2
a=0;//     #v2=(Boolean);v3=(Reference,Ljava/util/Iterator;);v7=(Reference,Landroid/widget/RemoteViews;);
a=0;//     move-object/from16 v0, p1
a=0;// 
a=0;//     iget-object v2, v0, Landroid/support/v4/app/NotificationCompat$Builder;->mStyle:Landroid/support/v4/app/NotificationCompat$Style;
a=0;// 
...
a=0;// 
a=0;//     #v2=(Reference,Landroid/support/v4/app/NotificationCompat$Style;);
a=0;//     check-cast v2, Landroid/support/v4/app/NotificationCompat$InboxStyle;
a=0;// 
a=0;//     .line 134
a=0;//     iget-object v3, v2, Landroid/support/v4/app/NotificationCompat$InboxStyle;->mBigContentTitle:Ljava/lang/CharSequence;
a=0;// 
a=0;//     iget-boolean v4, v2, Landroid/support/v4/app/NotificationCompat$InboxStyle;->mSummaryTextSet:Z
a=0;// 
a=0;//     #v4=(Boolean);
a=0;//     iget-object v5, v2, Landroid/support/v4/app/NotificationCompat$InboxStyle;->mSummaryText:Ljava/lang/CharSequence;
a=0;// 
a=0;//     iget-object v2, v2, Landroid/support/v4/app/NotificationCompat$InboxStyle;->mTexts:Ljava/util/ArrayList;
a=0;// 
a=0;//     invoke-virtual {v1, v3, v4, v5, v2}, Landroid/support/v4/app/NotificationCompatJellybean;->addInboxStyle(Ljava/lang/CharSequence;ZLjava/lang/CharSequence;Ljava/util/ArrayList;)V
a=0;// 
a=0;//     goto :goto_1
a=0;// 
a=0;//     .line 138
...
a=0;// 
a=0;//     .line 140
a=0;//     iget-object v2, v7, Landroid/support/v4/app/NotificationCompat$BigPictureStyle;->mBigContentTitle:Ljava/lang/CharSequence;
a=0;// 
a=0;//     iget-boolean v3, v7, Landroid/support/v4/app/NotificationCompat$BigPictureStyle;->mSummaryTextSet:Z
a=0;// 
a=0;//     #v3=(Boolean);
a=0;//     iget-object v4, v7, Landroid/support/v4/app/NotificationCompat$BigPictureStyle;->mSummaryText:Ljava/lang/CharSequence;
a=0;// 
a=0;//     #v4=(Reference,Ljava/lang/CharSequence;);
a=0;//     iget-object v5, v7, Landroid/support/v4/app/NotificationCompat$BigPictureStyle;->mPicture:Landroid/graphics/Bitmap;
a=0;// 
a=0;//     iget-object v6, v7, Landroid/support/v4/app/NotificationCompat$BigPictureStyle;->mBigLargeIcon:Landroid/graphics/Bitmap;
a=0;// 
a=0;//     iget-boolean v7, v7, Landroid/support/v4/app/NotificationCompat$BigPictureStyle;->mBigLargeIconSet:Z
a=0;// 
a=0;//     #v7=(Boolean);
